...
const awards = [
  ...
  { id: 2, title: 'Asian Book of Records - Participant', organization: 'Asian Book of Records', year: 2024, description: 'Group online event organized by Hallel Music School, India', icon: asianRecordsLogo, isImage: true, color: '#1e3a5f' },
  ...
  { id: 4, title: 'LCM Step 1 - Theory ', organization: 'London College of Music', year: 2024, description: 'LCM Step 1 (Theory) exam organized by Hallel Music School, India', icon: lcmLogo, isImage: true, color: '#20c997' },
];
    ...
    <section id="personal" className="py-32 bg-gray-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        <SectionTitle 
          ...
          subtitle="Beyond coding - my achievements and recognitions"
        />
