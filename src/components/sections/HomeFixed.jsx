        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight" style={{ color: theme.primary }}>
              Hi, I'm <span className="bg-clip-text text-transparent" style={{ backgroundImage: `linear-gradient(135deg, ${theme.secondary}, ${theme.accent})` }}>BSK</span>
            </h1>

            <p className="text-xl md:text-2xl mb-8 leading-relaxed" style={{ color: theme.textMuted }}>
              A passionate <span className="font-semibold" style={{ color: theme.primary }}>Full-Stack Developer</span> crafting beautiful digital experiences with modern technologies.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button onClick={() => {}} className="px-6 py-3 rounded-full text-lg font-medium border-2 flex items-center gap-2" style={{ borderColor: theme.primary, color: theme.primary }}>
                <FaDownload /> Download CV
              </button>
            </div>

            <div className="flex gap-12 mt-12 pt-12 border-t" style={{ borderColor: theme.textMuted + '30' }}>
              {[{ value: '8+', label: 'Years Experience' }, { value: '50+', label: 'Projects Completed' }, { value: '15+', label: 'Countries Visited' }].map((stat, idx) => (
                <div key={stat.label}>
              ...
              <div className="relative w-full aspect-square max-w-lg mx-auto">
                <div className="rings" style={{ width: 660, height: 660 }}>
                  ...
                  <div className="central-circle" style={{ width: 320, height: 320, background: `linear-gradient(135deg, ${theme.primary}, ${theme.secondary})` }}>
                    <span className="text-6xl font-bold">BSK</span>
                  </div>
                </div>
              </div>
          </div>
