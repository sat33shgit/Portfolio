...
# Identity
git config user.name "sat33shgit"
git config user.email "sateesh_b2000@yahoo.com"
...
git remote set-url origin "https://github.com/sat33shgit/Portfolio.git"
...
# manager).
if ($Token) {
    git push "https://sat33shgit:$Token@github.com/sat33shgit/Portfolio.git" main
} else {
